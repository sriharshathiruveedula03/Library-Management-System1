...
<style>
body {
    background-image:     linear-gradient(to bottom, rgba(245, 246, 252, 0.52), rgba(117, 19, 93, 0.73)),url("images/23.jpg");
...
<ul>
  ...
  <li><a class="active" href="facultymentorlogin">FacultyMentor</a></li>
</ul>

<br><br>

<h3 align=center><u>Add FacultyMentor</u></h3>
...
<form:form action="addfacultymentor" method="post" modelAttribute="mr">
