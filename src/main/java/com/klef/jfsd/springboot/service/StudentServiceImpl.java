...
public class StudentServiceImpl implements StudentService 
{
  ...
  @Override
  public int changestudentpassword(String studentoldpwd, String studentnewpwd, String studentuname)
  {
    
    return studentRepository.updatestudentpassword(studentnewpwd, studentoldpwd, studentuname);
  }
